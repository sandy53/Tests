 ...
 * 
 * @author zhangyg
 * @version $Id: HttpsUtils.java, v 0.1 2017年12月1日 上午11:34:25 zhangyg Exp $
 */
public final class HttpsUtils {
    private static Logger                             logger  = LoggerFactory
        .getLogger(HttpsUtils.class);
    ...
    /*    public static void main(String[] args) throws Exception {
        ...
        System.out.println(post("https://global.sumpay.cn:8088/webgate/realNameAuthentication.htm",
            null, null, null));
        System.out.println(post("https://global.sumpay.cn:8088/webgate/realNameAuthentication.htm",
            null, null, null));
        System.out.println("----------------s--" + System.currentTimeMillis());
